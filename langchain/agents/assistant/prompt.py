...
1300, 1200 is the left top coordinate of shoe, and 1510, 1290 is the right bottom coordinate of the shoe
soccer ball area is width*height = (1595-1476)*(1125-993)
1920 1307 is the width height dimension of the image

These are the tasks that Assistant can handle for an image: celebrities, landmarks, business card, receipt, objects, OCR, Bing
...
For example, to ask about an image that requires OCR (e.g. text, stamp, currency, money, dollar, paper, banknote in the image's object tags), make sure the question has the word OCR in it.
